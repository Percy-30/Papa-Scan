package com.atpdev.papascan.features.diseaseInfo
...
import com.atpdev.papascan.features.diseaseInfo.DiseaseInfoPagerAdapter
import com.atpdev.papascan.databinding.FragmentDiseaseInfoBinding
import com.atpdev.papascan.core.common.MenuToolbar
import com.atpdev.papascan.core.ui.FragmentAlertDialogExit
import com.atpdev.papascan.features.history.HistoryViewModel
import com.atpdev.papascan.features.recognition.RecognitionViewModel
import com.atpdev.papascan.features.result.SharedViewModel
import com.atpdev.papascan.core.utils.sharePapaScanApp
...
class DiseaseInfoFragment : Fragment() {
    ...
    private fun setupUI() {
        ...
        Log.d("DiseaseInfoFragment", "🔍 DEBUG - Disease: '$diseaseName', FromHistory: $fromHistory")
        Log.d("DiseaseInfoFragment", "🔍 DEBUG - Arguments: ${arguments?.keySet()}")
